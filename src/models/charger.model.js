...
const chargerSchema = new mongoose.Schema(
  {
    name: {
      type: String,
      required: [true, 'Please provide a charger name'],
      trim: true,
    },
    price: {
      type: Number,
...
chargerSchema.virtual('finalPrice').get(function () {
...
chargerSchema.set('toJSON', { virtuals: true });
chargerSchema.set('toObject', { virtuals: true });
